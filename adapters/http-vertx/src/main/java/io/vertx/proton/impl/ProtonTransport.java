...
class ProtonTransport extends BaseHandler {
    ...
    static {
        System.err.println("WARNING: Using patched ProtonTransport");
        System.out.println("WARNING: Using patched ProtonTransport");
    }
  ...
  private void handleException(final Throwable error) {
    LOG.error("Unhandled exception. Closing socket", error);
    this.socket.end();
  }
